...
const limits: Section = {
  ...
  topics: [
    ...
    t("limits", "epsilon-delta", "Определение по Коши (ε–δ)", { level: 3, tags: ["предел", "Коши", "теория"], status: "planned", description: "Строгое определение предела — теория Стрэнга." }),
    t("limits", "remarkable", "Замечательные пределы", { level: 2, tags: ["предел", "формулы"], status: "planned" }),
