...
export const CROSSLINKS: CrossLink[] = [
  ...
  // Последовательности ↔ пределы на бесконечности: один и тот же предельный переход.
  { a: "series-sequences", b: "limits-at-infinity", note: "Предел последовательности как предел на бесконечности" },
